        ...
        <div class="row">
            ...
            <div class="col-md-4" style="padding-left: 3px;">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        {{trans('home.account_bandwidth_usage')}}：{{$info['usedTransfer']}}（{{$info['totalTransfer']}}）@if($reset_traffic) &ensp;{{trans('home.account_reset_notice', ['reset_day' => $info['traffic_reset_day']])}}  @endif
